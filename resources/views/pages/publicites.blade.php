        						...
        						<tbody>
        							...
        							<tr>
        								...
        								<td>
        									...
        									<form action="{{ route('publicites.destroy', $item->id) }}" method="POST" style="display: inline-block">
        										{{ csrf_field() }}
				    	...
				    	<div class="row">
				    		<div class="col-md-6 col-sm-6 col-xs-12">
								<div class='form-group'>
									...
									<input type='text' class='form-control' name='publicite' required>
								</div>
							</div>
				    		<div class="col-md-6 col-sm-6 col-xs-12">
								<div class='form-group'>
	...
	<div class="modal fade" id="_edit{{ $item->id }}">
	    <div class="modal-dialog modal-lg">
			<div class="modal-content card card-primary">
			    ...
			    <form action="{{ route('publicites.update', $item->id) }}" method="POST" enctype="multipart/form-data">
			    	{{ csrf_field() }}
				    ...
				    <div class="card-body">
				    	<div class="row">
				    		<div class="col-md-6 col-sm-6 col-xs-12">
								<div class='form-group'>
									<div>Publicité <span class="text-danger">*</span></div>
									<input type='text' class='form-control' name='publicite' value="{{ $item->publicite }}" required>
								</div>
							</div>
				    		<div class="col-md-6 col-sm-6 col-xs-12">
								<div class='form-group'>
